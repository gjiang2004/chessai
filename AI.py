...
class AI:
    ...
    def calculateb(self,gametiles):
        ...
        bpawn = [[  0,   0,   0,   0,   0,   0,   0,   0],
                ...
                [ -20,   0,  10,  25,  25,  10,   0, -20],
                [ -10,  10,  30,  40,  40,  30,  10, -10],
                [   0,  20,  35,  50,  50,  35,  20,   0],
                [  15,  25,  40,  55,  55,  40,  25,  15],
                [  80,  90, 100, 110, 110, 100,  90,  80],
                [1000,1000,1000,1000,1000,1000,1000,1000]]

        wpawn = [[1000,1000,1000,1000,1000,1000,1000,1000],
                [   80,  90, 100, 110, 110, 100,  90,  80],
                [   15,  25,  40,  55,  55,  40,  25,  15],
                [    0,  20,  35,  50,  50,  35,  20,   0],
                [  -10,  10,  30,  40,  40,  30,  10, -10],
        ...
        bknight =   [[-50, -30, -25, -15, -15, -25, -30, -50],
        ...
        wknight =   [[-30, -15, -5,    0,   0,  -5, -15, -30],
                    ...
                    [ -20,   0,  20,  25,  25,  20,   0, -20],
                    [ -30, -10,   0,  10,  10,   0, -10, -30],
                    [ -50, -30, -25, -15, -15, -25, -30, -50]]

        bbishop =   [[-50, -20, -10,  -5,  -5, -10, -20, -50],
